...
-- Volcando datos para la tabla bd_coremas.categoria: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `categoria` DISABLE KEYS */;
INSERT INTO `categoria` (`id`, `nombre_categoria`, `descripcion_categoria`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Tecnologia', 'Tecnologia', '2019-02-09 13:11:52', '2019-02-09 13:11:53', NULL);
...
CREATE TABLE IF NOT EXISTS `donaciones` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `donaciones_proyecto_id_foreign` (`proyecto_id`),
  CONSTRAINT `donaciones_proyecto_id_foreign` FOREIGN KEY (`proyecto_id`) REFERENCES `proyecto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Volcando datos para la tabla bd_coremas.migrations: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `migrations` DISABLE KEYS */;
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	(1, '2014_10_12_000000_create_users_table', 1),
	(2, '2014_10_12_100000_create_password_resets_table', 1),
	(5, '2018_11_24_232404_add_id_profile_to_users', 2),
	(6, '2019_02_09_175953_add_conseguido_to_proyecto', 2),
	(7, '2019_02_09_180547_add_proyecto_id_to_donaciones', 3);
...
CREATE TABLE IF NOT EXISTS `proyecto` (
  ...
  `dinero_conseguido` double NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `proyecto_to_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla bd_coremas.proyecto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `proyecto` DISABLE KEYS */;
INSERT INTO `proyecto` (`id`, `nombre_proyecto`, `user_id`, `descripcion_proyecto`, `fase_proyecto`, `publico_objetivo`, `problema_proyecto`, `solucion_proyecto`, `ventaja_proyecto`, `propuesta_proyecto`, `costos_proyecto`, `valor_proyecto`, `dinero_conseguido`, `plazo_financiacion`, `video_proyecto`, `descripcion_extra`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(2, 'Prueba', 2, '2', '2', '2', '2', '2', '2', '2', 3, 3, 0, '2019-02-09', NULL, NULL, '2019-02-09 13:15:34', '2019-02-09 13:15:33', NULL);
...
-- Volcando datos para la tabla bd_coremas.users: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(2, 'Miguel Angel', 'miguel-sg01@hotmail.com', NULL, '$2y$10$ITMYIdKahKJaufgWFcOWzOYJZengT4wCpZzMjMXGDq500qfSjI8C.', NULL, '2019-02-09 18:13:58', '2019-02-09 18:13:58', NULL);
