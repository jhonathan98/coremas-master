...
var arr=['https://coremas.com.co/imagenes/slide/imagen1/materializa-tus-ideas-y-suenos1712.png']; //an array of image sources
...
$(document).ready(function () {
    ...
    function next(){
        ...
        $('#slider').html('<img src="'+arr[pos+1]+'" class="img-slide ">');//show image
        pos++;
    ...
    function previous() {
        ...
        //image-animated to zoom images
        $('#slider').html('<img src="'+arr[pos-1]+'" class="img-slide ">');
        pos--;
